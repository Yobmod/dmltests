...
N_LIB_PRIVATE N_NIMCALL(void, initDeque_ReEIfP39bwVCXJ79bSWPO49aw)(NI initialSize, tyObject_Deque_lXZKLUMbpAcAUzeVrG09bNg* Result) {
	...
	unsureAsgnRef((void**) (&(*Result).data), (tySequence_WF89a8QyKeDCh4DYWTmSiBg*) newSeq((&NTI_WF89a8QyKeDCh4DYWTmSiBg_), ((NI)chckRange(initialSize, ((NI) 0), ((NI) 2147483647)))));
	popFrame();
}
...
N_LIB_PRIVATE N_NIMCALL(void, expandIfNeeded_yUfcbmt639aJ6tr007RgLpQ)(tyObject_Deque_lXZKLUMbpAcAUzeVrG09bNg* deq) {
	...
	nimln_(130, "deques.nim");
	{
		...
		n = newSeq_9cuYsYikMZ9a6LEmMiXrzHTQ(((NI)chckRange((NI)(TM_NdgYN5HU2ty0qMI5oazWyg_7), ((NI) 0), ((NI) 2147483647))));
		{
			NI i;
...
N_LIB_PRIVATE N_NIMCALL(void, expandIfNeeded_fb7lS9aYiZuD9aRpBRNuQNBg)(tyObject_Deque_104cP4q8EyDjHrsh1Phrmw* deq) {
	...
	nimln_(130, "deques.nim");
	{
		...
		n = newSeq_U5hr1aflwKP9cnEP9cdTyPKA(((NI)chckRange((NI)(TM_NdgYN5HU2ty0qMI5oazWyg_15), ((NI) 0), ((NI) 2147483647))));
		{
			NI i;
			NimStringDesc* x;
...
N_LIB_PRIVATE N_NIMCALL(void, initDeque_9bAxh9aiIW8x9cABzXt8aTZyA)(NI initialSize, tyObject_Deque_104cP4q8EyDjHrsh1Phrmw* Result) {
	...
	nimln_(60, "deques.nim");
	unsureAsgnRef((void**) (&(*Result).data), (tySequence_sM4lkSb7zS6F7OVMvW9cffQ*) newSeq((&NTI_sM4lkSb7zS6F7OVMvW9cffQ_), ((NI)chckRange(initialSize, ((NI) 0), ((NI) 2147483647)))));
	popFrame();
}
