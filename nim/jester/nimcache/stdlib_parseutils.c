...
STRING_LITERAL(TM_vI9aZNKIcImom6dDyKXW1ZA_30, "", 0);
		...
		(*b) = ((NI) 0);
		{
			...
			while (1) {
				...
				nimln_(289, "parseutils.nim");
				{
					...
					TM_vI9aZNKIcImom6dDyKXW1ZA_18 = subInt(((NI) 2147483647), c);
...
static N_INLINE(NI, skipUntil_QyJT1KOOKqocMdeiftWwcwparseutils)(NimStringDesc* s, NIM_CHAR until, NI start) {
	...
	result = (NI)0;
	{
		nimln_(168, "parseutils.nim");
		while (1) {
			NIM_BOOL T3_;
			NI TM_vI9aZNKIcImom6dDyKXW1ZA_25;
			NI TM_vI9aZNKIcImom6dDyKXW1ZA_26;
			NI TM_vI9aZNKIcImom6dDyKXW1ZA_27;
			T3_ = (NIM_BOOL)0;
			nimln_(398, "system.nim");
			nimln_(168, "parseutils.nim");
			TM_vI9aZNKIcImom6dDyKXW1ZA_25 = addInt(result, start);
			if ((NU)((NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_25)) > (NU)(s->Sup.len)) raiseIndexError();
			T3_ = !(((NU8)(s->data[(NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_25)]) == (NU8)(until)));
			if (!(T3_)) goto LA4_;
			nimln_(398, "system.nim");
			nimln_(168, "parseutils.nim");
			TM_vI9aZNKIcImom6dDyKXW1ZA_26 = addInt(result, start);
			if ((NU)((NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_26)) > (NU)(s->Sup.len)) raiseIndexError();
			T3_ = !(((NU8)(s->data[(NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_26)]) == (NU8)(0)));
			LA4_: ;
			if (!T3_) goto LA2;
			TM_vI9aZNKIcImom6dDyKXW1ZA_27 = addInt(result, ((NI) 1));
			result = (NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_27);
		} LA2: ;
	}
	popFrame();
	return result;
...
static N_INLINE(NI, parseUntil_NGJAHkdW7mFJbCRar9a8aQwhttpcore)(NimStringDesc* s, NimStringDesc** token, NIM_CHAR until, NI start) {
	...
	TM_vI9aZNKIcImom6dDyKXW1ZA_32 = subInt(i, start);
	result = (NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_32);
	nimln_(193, "parseutils.nim");
	TM_vI9aZNKIcImom6dDyKXW1ZA_33 = subInt(i, ((NI) 1));
	unsureAsgnRef((void**) (&(*token)), copyStrLast(s, start, (NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_33)));
	popFrame();
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, captureBetween_SaijU9ajAPMQZgtQ7Dt01aw)(NimStringDesc* s, NIM_CHAR first, NIM_CHAR second, NI start) {
	...
	NI TM_vI9aZNKIcImom6dDyKXW1ZA_29;
	NIM_CHAR T2_;
	NI T8_;
	...
	TM_vI9aZNKIcImom6dDyKXW1ZA_28 = addInt(T1_, ((NI) 1));
	TM_vI9aZNKIcImom6dDyKXW1ZA_29 = addInt((NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_28), start);
	i = (NI)(TM_vI9aZNKIcImom6dDyKXW1ZA_29);
	nimln_(225, "parseutils.nim");
	result = copyString(((NimStringDesc*) &TM_vI9aZNKIcImom6dDyKXW1ZA_30));
