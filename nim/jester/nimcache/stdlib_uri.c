...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, encodeUrl_H9bjIhbPEDIqP3g9cmua3TpQ)(NimStringDesc* s) {
	...
	result = (NimStringDesc*)0;
	nimln_(55, "uri.nim");
	TM_VzbRQH9cb1xm1tSKH4PwBSw_3 = addInt((s ? s->Sup.len : 0), (NI)((NU32)((s ? s->Sup.len : 0)) >> (NU32)(((NI) 2))));
	result = rawNewString(((NI)chckRange((NI)(TM_VzbRQH9cb1xm1tSKH4PwBSw_3), ((NI) 0), ((NI) 2147483647))));
	{
		NI i;
		NI colontmp_;
...
static N_INLINE(void, handleHexChar_g0Mc9bquhMvGhJuSAXY34qguri)(NIM_CHAR c, NI* x) {
	...
	case 48 ... 57:
	{
		...
		(*x) = (NI)((NI)((NU32)((*x)) << (NU32)(((NI) 4))) | (NI)(TM_VzbRQH9cb1xm1tSKH4PwBSw_6));
	}
	break;
	case 97 ... 102:
	{
		...
		(*x) = (NI)((NI)((NU32)((*x)) << (NU32)(((NI) 4))) | (NI)(TM_VzbRQH9cb1xm1tSKH4PwBSw_8));
	}
	break;
	case 65 ... 70:
	{
		...
		(*x) = (NI)((NI)((NU32)((*x)) << (NU32)(((NI) 4))) | (NI)(TM_VzbRQH9cb1xm1tSKH4PwBSw_10));
	}
	break;
	default:
	{
