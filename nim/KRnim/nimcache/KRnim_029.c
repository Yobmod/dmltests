...
N_NIMCALL(void, main_vB69c4cpIz0IrIhiLjrtxLw)(void);
...
N_NIMCALL(NI, power_R2vCwvz2dE1KDu9aNn7It9aw)(NI base, NI n);
...
STRING_LITERAL(TM_y6nRJOi7ohc2gbvu8DlOtQ_2, "$1 $2 $3 \015\012", 11);
	...
	nimfr_("main", "KRnim_029.nim");
	{
		...
		res = ((NI) 1);
		{
			...
			while (1) {
				...
				T4_[0] = nimIntToStr(i);
				T5_ = (NI)0;
				T5_ = power_R2vCwvz2dE1KDu9aNn7It9aw(((NI) 2), i);
				T4_[1] = nimIntToStr(T5_);
				T6_ = (NI)0;
				T6_ = power_R2vCwvz2dE1KDu9aNn7It9aw(((NI) -3), i);
				T4_[2] = nimIntToStr(T6_);
				T7_ = (NimStringDesc*)0;
				T7_ = nsuFormatVarargs(((NimStringDesc*) &TM_y6nRJOi7ohc2gbvu8DlOtQ_2), T4_, 3);
