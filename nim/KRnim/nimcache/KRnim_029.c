...
N_LIB_PRIVATE N_NIMCALL(void, main_vB69c4cpIz0IrIhiLjrtxLw)(void);
...
N_LIB_PRIVATE N_NIMCALL(NI, power_R2vCwvz2dE1KDu9aNn7It9aw)(NI base, NI n);
static N_INLINE(void, stareq__tk9bwZBdb9bO9baUcUN2AX89bQKRnim_029)(NI* x, NI y);
...
NIM_EXTERNC N_NOINLINE(void, KRnim_029DatInit000)(void);
extern TFrame* framePtr_HRfVMH3jYeBJz6Q6X9b6Ptw;
STRING_LITERAL(TM_y6nRJOi7ohc2gbvu8DlOtQ_2, "$1 $2 $3 \012", 10);
	...
	nimfr_("main", "KRnim_029.nim");
	{
		...
		res = ((NI) 1);
		{
			...
			while (1) {
				...
				NI T6_;
				NI T7_;
				NI TM_y6nRJOi7ohc2gbvu8DlOtQ_3;
				if (!(res <= ((NI) 10))) goto LA3;
				nimln_(2034, "system.nim");
				i = res;
				nimln_(8, "KRnim_029.nim");
				memset((void*)T4_, 0, sizeof(T4_));
				memset((void*)T5_, 0, sizeof(T5_));
				T5_[0] = nimIntToStr(i);
				T6_ = (NI)0;
				T6_ = power_R2vCwvz2dE1KDu9aNn7It9aw(((NI) 2), i);
				T5_[1] = nimIntToStr(T6_);
				T7_ = (NI)0;
				T7_ = power_R2vCwvz2dE1KDu9aNn7It9aw(((NI) -3), i);
				T5_[2] = nimIntToStr(T7_);
				T4_[0] = nsuFormatVarargs(((NimStringDesc*) &TM_y6nRJOi7ohc2gbvu8DlOtQ_2), T5_, 3);
				echoBinSafe(T4_, 1);
				nimln_(2035, "system.nim");
				TM_y6nRJOi7ohc2gbvu8DlOtQ_3 = addInt(res, ((NI) 1));
				res = (NI)(TM_y6nRJOi7ohc2gbvu8DlOtQ_3);
			} LA3: ;
		}
	}
	popFrame();
...
static N_INLINE(void, stareq__tk9bwZBdb9bO9baUcUN2AX89bQKRnim_029)(NI* x, NI y) {
	NI TM_y6nRJOi7ohc2gbvu8DlOtQ_4;
	nimfr_("*=", "system.nim");
	nimln_(3695, "system.nim");
	TM_y6nRJOi7ohc2gbvu8DlOtQ_4 = mulInt((*x), y);
	(*x) = (NI)(TM_y6nRJOi7ohc2gbvu8DlOtQ_4);
	popFrame();
}
...
N_LIB_PRIVATE N_NIMCALL(NI, power_R2vCwvz2dE1KDu9aNn7It9aw)(NI base, NI n) {
	NI result;
	NI p;
	nimfr_("power", "KRnim_029.nim");
{	result = (NI)0;
	nimln_(12, "KRnim_029.nim");
	p = ((NI) 1);
	{
		NI i;
		NI res;
		...
		res = ((NI) 1);
		{
			...
			while (1) {
				NI TM_y6nRJOi7ohc2gbvu8DlOtQ_5;
				if (!(n <= res)) goto LA3;
				nimln_(2017, "system.nim");
				i = res;
				nimln_(14, "KRnim_029.nim");
				stareq__tk9bwZBdb9bO9baUcUN2AX89bQKRnim_029((&p), base);
				nimln_(2018, "system.nim");
				TM_y6nRJOi7ohc2gbvu8DlOtQ_5 = subInt(res, ((NI) 1));
				res = (NI)(TM_y6nRJOi7ohc2gbvu8DlOtQ_5);
			} LA3: ;
		}
	}
	nimln_(15, "KRnim_029.nim");
	result = p;
	goto BeforeRet_;
	}BeforeRet_: ;
	popFrame();
...
NIM_EXTERNC N_NOINLINE(void, NimMainModule)(void) {
	nimfr_("KRnim_029", "KRnim_029.nim");
	nimln_(17, "KRnim_029.nim");
	main_vB69c4cpIz0IrIhiLjrtxLw();
	popFrame();
}
