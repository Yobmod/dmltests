...
N_LIB_PRIVATE N_NIMCALL(void, reverse_mQ8DLDwXOrhttpnP9a8kayA)(NimStringDesc** a, NI aLen_0, NI first, NI last);
...
N_LIB_PRIVATE N_NIMCALL(void, reverse_mQ8DLDwXOrhttpnP9a8kayA)(NimStringDesc** a, NI aLen_0, NI first, NI last) {
	...
	y = last;
	{
		...
		while (1) {
			...
			if (TM_JdC9c6SaUkvO1XjYuWP1JWQ_4 < 0 || TM_JdC9c6SaUkvO1XjYuWP1JWQ_4 > 2147483647) raiseOverflow();
			y = (NI)(TM_JdC9c6SaUkvO1XjYuWP1JWQ_4);
			nimln_(45, "algorithm.nim");
			TM_JdC9c6SaUkvO1XjYuWP1JWQ_5 = addInt(x, ((NI) 1));
			if (TM_JdC9c6SaUkvO1XjYuWP1JWQ_5 < 0 || TM_JdC9c6SaUkvO1XjYuWP1JWQ_5 > 2147483647) raiseOverflow();
...
N_LIB_PRIVATE N_NIMCALL(void, reverse_LoixoqZetR6FfezoPedx8w)(NimStringDesc** a, NI aLen_0) {
	...
	reverse_mQ8DLDwXOrhttpnP9a8kayA(a, aLen_0, ((NI) 0), ((NI)chckRange(((((NI) 0) >= (aLen_0-1)) ? ((NI) 0) : (aLen_0-1)), ((NI) 0), ((NI) 2147483647))));
	popFrame();
}
