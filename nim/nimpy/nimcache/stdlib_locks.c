...
tyProc_KeCiSdV9aG0JRdXpLIxCQ9cQ Dl_62844_;
tyProc_ofoySXaAAlxxs9bQS9a1etlg Dl_62850_;
tyProc_FprzxJFfqQdWyyGxiUsmeQ Dl_62853_;
tyProc_ofoySXaAAlxxs9bQS9a1etlg Dl_62857_;
...
static N_INLINE(void, initSysCond_05dikp5SjY49b5qLvlucEZglocks)(NI* cond) {
	(*cond) = Dl_62844_(NIM_NIL, ((NI32) 0), ((NI32) 0), NIM_NIL);
}
...
if (!((TM_05xOtLU9bCAYnon4m09bcBlg_2 = nimLoadLibrary((NimStringDesc*) &TM_05xOtLU9bCAYnon4m09bcBlg_4))
	...
	Dl_62844_ = (tyProc_KeCiSdV9aG0JRdXpLIxCQ9cQ) nimGetProcAddr(TM_05xOtLU9bCAYnon4m09bcBlg_2, "CreateEventA");
	Dl_62850_ = (tyProc_ofoySXaAAlxxs9bQS9a1etlg) nimGetProcAddr(TM_05xOtLU9bCAYnon4m09bcBlg_2, "CloseHandle");
	Dl_62853_ = (tyProc_FprzxJFfqQdWyyGxiUsmeQ) nimGetProcAddr(TM_05xOtLU9bCAYnon4m09bcBlg_2, "WaitForSingleObject");
	Dl_62857_ = (tyProc_ofoySXaAAlxxs9bQS9a1etlg) nimGetProcAddr(TM_05xOtLU9bCAYnon4m09bcBlg_2, "SetEvent");
}
