...
class Application(tk.Frame):
    ...
    def __init__(self, master: Optional[tk.Tk]=None) -> None:
        ...
        self.create_widgets()
        style = ttk.Style()
        style.configure("BW.TButton", foreground="red", background="red")
    ...
    def create_widgets(self) -> None:
        ...
        #self.hi_there["style"] = "BW.TButton"
        self.hi_there.pack(side="top")

        self.bf_button = ttk.Button(self, text="Brainfuck", command=self.bf_command)
        self.bf_button.pack(side="left")

        self.quit_button = ttk.Button(self, text="QUIT", style="BW.TButton", command=root.destroy)
