"""Identify objects from  a video stream using a keras pre-trained model"""
# import time
...
while(True):
    ...
    # get ROI
    roi: imageType = frame[75 + 2:425 - 2, 300 + 2:650 - 2]
    ...
    cv2.putText(frame, label_3, (70, 230), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (20, 20, 240), 2)
