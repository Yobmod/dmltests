...
@overload
def stack(a: Tuple[Union[Sequence[float], _ArrayLike[float]], Union[Sequence[float], _ArrayLike[float]]]) -> ndarray[float]: ...


def stack(a: Tuple[Union[Sequence[Any], _ArrayLike[Any]], Union[Sequence[Any], _ArrayLike[Any]]]) -> ndarray[Any]: ...


def argmin(a: _ArrayLike[Any]) -> int: ...
