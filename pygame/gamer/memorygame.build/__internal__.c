...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_6_complex_call_helper_keywords_star_list( PyObject **python_pars );
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_8_complex_call_helper_star_dict( PyObject **python_pars )
{
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_8_complex_call_helper_star_dict );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    {
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_6_complex_call_helper_keywords_star_list( PyObject **python_pars )
{
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_6_complex_call_helper_keywords_star_list );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    {
