...
static PyObject *const_str_digest_fc3fe97f815c422be5c76411f9e9c0ca;
...
{
    const_str_digest_fc3fe97f815c422be5c76411f9e9c0ca = UNSTREAM_STRING( &constant_bin[ 88054 ], 12, 0 );
    const_str_digest_aa4691fa99fd8537fd0533c8214db9b9 = UNSTREAM_STRING( &constant_bin[ 88066 ], 18, 0 );
...
static PyCodeObject *codeobj_96187c2d286b602649e7a80b9482470a;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_fc3fe97f815c422be5c76411f9e9c0ca );
    codeobj_96187c2d286b602649e7a80b9482470a = MAKE_CODEOBJ( module_filename_obj, const_str_digest_aa4691fa99fd8537fd0533c8214db9b9, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_96187c2d286b602649e7a80b9482470a;
    ...
    // Frame without reuse.
    frame_96187c2d286b602649e7a80b9482470a = MAKE_MODULE_FRAME( codeobj_96187c2d286b602649e7a80b9482470a, module_pythoncom );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_96187c2d286b602649e7a80b9482470a );
    assert( Py_REFCNT( frame_96187c2d286b602649e7a80b9482470a ) == 2 );
    ...
    frame_96187c2d286b602649e7a80b9482470a->m_frame.f_lineno = 2;
    ...
    frame_96187c2d286b602649e7a80b9482470a->m_frame.f_lineno = 3;
    {
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_96187c2d286b602649e7a80b9482470a );
#endif
    popFrameStack();

    assertFrameObject( frame_96187c2d286b602649e7a80b9482470a );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_96187c2d286b602649e7a80b9482470a, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_96187c2d286b602649e7a80b9482470a->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_96187c2d286b602649e7a80b9482470a, exception_lineno );
    }
